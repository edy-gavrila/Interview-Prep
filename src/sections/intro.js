  ...
  articles: [
    {
      ...
      text: [
        ...
        "Why should you read on? Firstly you can learn a lot of JavaScript stuff as I intent to write here anything that I am trying to learn to explain. Secondly, if you are prepairing for a technical interview yourself, I am planning to explain how I found my journey to be, what I learned from it and were my mistakes.",
        "Lets go!",
      ],
    },

    {
      ...
      text: [
        ...
        "I knew I had to start from the basics. HTML, CSS, JavaScript. So I jumped on FreeCodeCamp (google it!) and cracked on. It wasn't easy but one big advantage was that I could see the fruits of my learning almost imediately, by building small projects.",
